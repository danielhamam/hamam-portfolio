    ...
    <div id="home-nav-wrapper" className='container'>
        <div className='row'> 
            <div className='col-md-5'>
                <div> 
                    <img src={about}/>
                    <br/>
                    <span className='home-nav-font'> Learn a little bit about me & the start of my career as a software engineer </span>
                    <br/>
                    <br/>
        ...
        <div className='row'>
            ...
            <div className='offset-md-2 col-md-5'>
                ...
                <br/>
                <span className='home-nav-font'> Take a stroll through an album of pictures I took sometime in my life </span>
                <br/>
                <br/>
